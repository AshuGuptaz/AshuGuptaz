...
- **SWE Intern @ VIAVI Solutions** — enterprise network monitoring, Spring Boot APIs, AI-driven anomaly detection
...
#### [RAG-Based Document Q&A System](https://github.com/AshuGuptaz/rag-document-qa)
> Python · LangChain · ChromaDB · FastAPI · Groq API (Llama 3.1) · JWT · AWS S3

Production-ready RAG pipeline for natural language Q&A over private documents.
- **90%+ answer relevance** with ChromaDB vector embeddings grounding responses in source docs
- JWT-secured REST API with **sub-2s response time** and concurrent multi-user support
- AWS S3 document storage + dynamic prompt engineering for context-aware answers

---

#### [CloudVault — Cloud File Management API](https://github.com/AshuGuptaz/cloud-file-management)
> Java · Spring Boot · Spring Security · JWT · AWS S3 · MySQL · REST API

Secure cloud file management system with enterprise-grade access control.
- **RBAC + JWT** securing 100% of 40+ API endpoints via Spring Security
- AWS S3 integration for scalable PDF/image storage with real-time upload, retrieval & deletion
- **40% faster** content retrieval with optimized MySQL schema and full-text search
